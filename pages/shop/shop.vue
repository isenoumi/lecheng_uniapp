<template>
  <view>
    <view class="box">
      <view class="u-nav">
        <navbar
          ...
          placeholder
          height="55"
          imageSrc="https://oms.cestech.com.cn/BkpKnowledge/img/2f1ae13f46fc4dd5b556a7c2fdb1d559/组 7045@2x.png"
          bgColor="transparent"
          :leftIcon="false">
    ...
    <image
      ...
      src="http://cdn.cestech.com.cn/BkpKnowledge/img/049387343ca8494e86822aa6a303177f.png"
      mode="scaleToFill" />
    ...
    <view class="topBox">
      <view class="item" @click="shoppingOrder">
        <image
          class="image"
          src="http://cdn.cestech.com.cn/BkpKnowledge/img/2422c7f15016459792a3830882de102d.png"
          mode="scaleToFill" />
      ...
      <view class="item" @click="integral">
        <image
          class="image"
          src="https://oms.cestech.com.cn/BkpKnowledge/img/46aa47c3640f45ba848e177b54179eba/蒙版组 15.png"
          mode="scaleToFill" />
           ...
           <view style="height: 20rpx;"></view> -->
            <view
              ...
              <view
                ...
                ">
                <view
                  style="width: 336rpx; text-align: center"
