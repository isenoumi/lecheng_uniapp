...
export function getMyCarbonRanking(data) {
  return request({
    'url': '/mission_gh/v1/mycarbonCreditsRank',
    'method': 'get',
    params: data
  })
}
export function getCarbonRankingList(data) {
  return request({
    'url': '/mission_gh/v1/carbonCreditsRank',
    'method': 'get',
    params: data
  })
}
