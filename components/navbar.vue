<template>
  <view class="u-navbar">
    ...
    <view :class="[fixed && 'u-navbar--fixed']">
      ...
      <view v-if="allTitle" class="white-space"> </view>
      <u-status-bar
        v-if="safeAreaInsetTop"
        :bgColor="hasImage ? 'transparent' : bgColor"></u-status-bar>
      <view
...
export default {
  ...
  props: {
    ...
    imageSrc: {
      type: String,
      default: '/static/assets/路径 8959.png',
      // 'http://cdn.cestech.com.cn/BkpKnowledge/img/7dad06034e0d481e8b0bae9356184972.png',
    },
    allTitle: {
      type: Boolean,
      default: true,
